      ...
      <div>
        ...
        <div className="flex flex-col space-y-4 mt-4 font-medium text-xs sm:text-sm lg:text-base ">
          ...
          <span>
            ...
            />
            <button className="z-100 -ml-16 sm:-ml-24 lg:-ml-32 bg-black text-white py-[0.88rem] sm:py-[0.6rem] lg:py-[0.88rem] px-7 sm:px-4 lg:px-7 rounded-md font-light shadow-lg">
              Subscribe
            </button>
          </span>
        </div>
